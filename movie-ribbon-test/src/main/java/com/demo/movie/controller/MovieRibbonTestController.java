...
@RestController
public class MovieRibbonTestController {
...
//        return u;
    ...
    public List<User> findById() {
        List<User> list = rest.getForObject("http://user/list_all", List.class);
        return list;
    }
    ...
    public String test(){
        ...
        ServiceInstance instance3 = loadBalancerClient.choose("user3");
        System.out.println(instance3.getHost() + ":" + instance3.getPort()+ ":" + instance3.getServiceId());
        return "1";
    }
}
